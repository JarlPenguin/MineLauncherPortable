...
user in an INI file next to MineLauncherPortable.exe called MineLauncherPortable.ini.
...
copy AppNamePortable.ini from this directory to MineLauncherPortable.ini next to
MineLauncherPortable.exe. The options in the INI file are as follows:
